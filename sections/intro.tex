...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.95\textwidth}{figs/db-si}
    \column{0.50\textwidth}
      \fig{width = 0.95\textwidth}{figs/acid}
  \end{columns}

  \vspace{0.30cm}
  \begin{center}
    \red{隔离性}要求并发执行的事务互不干扰, 避免上层业务产生数据异常
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.75\textwidth}{figs/verification-problems}
\end{frame}
%%%%%%%%%%%%%%%%%%%%