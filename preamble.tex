...
\usepackage{amssymb, pifont, latexsym}
...
\newcommand{\thankyou}{
  \begin{frame}[noframenumbering]
    \begin{center}
      ...
      \vspace{0.30cm}
      魏恒峰 (hengfeng\_wei@126.com)
      \vspace{0.30cm}
      \begin{columns}
        \column{0.55\textwidth}
          \fig{width = 0.50\textwidth}{figs/dbconf2025-qrcode}
          \vspace{-0.50cm}
          \centerline{\scriptsize \url{https://github.com/reports-by-hfwei/dbconf2025}}
        \column{0.45\textwidth}
          \fig{width = 0.60\textwidth}{figs/homepage-qrcode}
          \vspace{-0.50cm}
          \centerline{\scriptsize \url{https://hengxin.github.io/}}
      \end{columns}
    \end{center}
  \end{frame}
}
